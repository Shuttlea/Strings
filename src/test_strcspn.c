...
START_TEST(strcspn_1) {
  char s1[] =
      "The clouds formed beautiful animals in the sky that eventually created "
      "a tornado to wreak havoc.";
...
START_TEST(strcspn_3) {
  char s1[] =
      "It took me too long to realize that the ceiling hadn't been painted to "
      "look like the sky.";
  char s2[] = "sky";
  ck_assert_int_eq(strcspn(s1, s2), s21_strcspn(s1, s2));
}
...
START_TEST(strcspn_4) {
  char s1[] = "";
  char s2[] =
      "The tears of a clown make my lipstick run, but my shower cap is still "
      "intact.";
  ck_assert_int_eq(strcspn(s1, s2), s21_strcspn(s1, s2));
}
END_TEST
...
Suite *test_strcspn() {
  ...
  TCase *test_group = tcase_create("s21_strcspn_test_group");
