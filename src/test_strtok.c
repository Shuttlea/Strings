...
START_TEST(strtok_4) {
  char s1[] =
      "They desperately needed another drummer since the current one only knew "
      "how to play bongos.";
  char s2[] =
      "They desperately needed another drummer since the current one only knew "
      "how to play bongos.";
...
START_TEST(strtok_5) {
  char s1[] =
      "I know many children ask for a pony, but I wanted a bicycle with "
...
START_TEST(strtok_9) {
  char s1[] =
      "While all her friends were positive that Mary had a sixth sense, she "
      "knew she actually had a seventh sense.";
  char s2[] =
      "While all her friends were positive that Mary had a sixth sense, she "
      "knew she actually had a seventh sense.";
  char s3[] = "Q";
...
Suite *test_strtok() {
  ...
  TCase *test_group = tcase_create("s21_strtok_test_group");
