...
START_TEST(memcmp_1) {
  char s1[] =
      "Patricia loves the sound of nails strongly pressed against the "
      "chalkboard.";
  char s2[] =
      "Patricia loves the sound of nails strongly pressed against the "
      "chalkboard.";
...
START_TEST(memcmp_2) {
  char s1[] =
      "The gruff old man sat in the back of the bait shop grumbling to himself "
      "as he scooped out a handful of worms.";
  char s2[] =
      "The gruff old man sat in the back of the bait shop grumbling to himself "
      "as he scooped out a handful of worms.";
  s21_size_t n = 0;
...
START_TEST(memcmp_3) {
  char s1[] =
      "Sometimes it is better to just walk away from things and go back to "
      "them later when youre in a better frame of mind.";
  char s2[] =
      "Sometimes it is better to just walk away from things and go back to "
      "them later when youre in a better frame of mind.";
  s21_size_t n = 14;
...
START_TEST(memcmp_10) {
  char s1[] =
      "Most shark attacks occur about 10 feet from the beach since that's "
...
Suite *test_memcmp() {
  ...
  TCase *test_group = tcase_create("s21_memcmp_test_group");
