...
START_TEST(strncpy_1) {
  char s1[100] =
      "If you really strain your ears, you can just about hear the sound of no "
      "one giving a damn.";
  char s2[100] =
      "If you really strain your ears, you can just about hear the sound of no "
      "one giving a damn.";
...
START_TEST(strncpy_3) {
  char s1[100] =
      "His thought process was on so many levels that he gave himself a phobia "
      "of heights.";
  char s2[100] =
      "His thought process was on so many levels that he gave himself a phobia "
      "of heights.";
...
START_TEST(strncpy_7) {
  ...
  char s3[] =
      "People generally approve of dogs eating cat food but not cats eating "
      "dog food.";
  s21_size_t n = 30;
  ck_assert_pstr_eq(strncpy(s1, s3, n), s21_strncpy(s2, s3, n));
}
...
START_TEST(strncpy_10) {
  char s1[100] =
      "Everyone was curious about the large white blimp that appeared "
      "overnight.";
  char s2[100] =
      "Everyone was curious about the large white blimp that appeared "
      "overnight.";
...
Suite *test_strncpy() {
  ...
  TCase *test_group = tcase_create("s21_strncpy_test_group");
